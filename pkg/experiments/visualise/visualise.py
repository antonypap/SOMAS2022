...
def plot_sanctioned(tracking: Any, filename: str) -> None:
    ...
    plt.title("Agent Defection and Sanction Evolution Over The Game For Up To 5 Randomly Selected Agents")
    # plt.title("Agent Sanctioned Evolution Over Game For Up To 5 Random Agents")
    plt.ylabel("Sanctioned: 0=False, 1=True, Defector: 2=False, 3=True")
